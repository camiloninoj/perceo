...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'anexoT.label', default: 'Anexo O')}" />
        <title><g:message code="default.list.label" args="[entityName]" /></title>
    </head>
    <body>
        <a href="#list-anexoO" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-anexoO" class="content scaffold-list" role="main">
            ...
            <g:jasperReport
              ...
              <div class="fieldcontain">
                 ...
                 <g:select name="tipoCombustible" from="${['DIESEL','CORRIENTE','EXTRA']}"/>
               </div>
            </g:jasperReport>
        </div>
    </body>
