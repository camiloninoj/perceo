...
<html>
    ...
    <body>
        ...
        <div id="edit-consumo" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.consumo}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.consumo}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.consumo}" method="PUT">
                <g:hiddenField name="version" value="${this.consumo?.version}" />
                <fieldset class="form">
                    <f:all bean="consumo"/>
                </fieldset>
