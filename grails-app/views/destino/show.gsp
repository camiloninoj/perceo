...
<html>
    ...
    <body>
        ...
        <div id="show-destino" class="content scaffold-show" role="main">
            ...
            <f:display bean="destino" />
            <g:form resource="${this.destino}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.destino}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
